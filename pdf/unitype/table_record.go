...
// tableRecord represents table records, including name (tag) and pdffile offset, size
...
// tableRecords represents a set of table records in a truetype font pdffile.
